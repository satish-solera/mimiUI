          ...
          {dummyDataSecond.map((el, id) => {
            return (
              ...
              ref={(el) => (listRef.current[id] = el)}
                ...
                className={
                  selectedList == id
                    ? `py-3 scale-[200px] transition-all ease-in duration-200 pl-4 px-10 bg-neutral-600 dark:bg-neutral-200 rounded-sm select-none text-white dark:text-black focus:ring-gray-200`
                    : `py-2 pl-4 px-10  active:bg-neutral-200 hover:bg-neutral-700  dark:hover:bg-neutral-300 rounded-sm select-none dark:text-black focus:ring-gray-200`
                }
